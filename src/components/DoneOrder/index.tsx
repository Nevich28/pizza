...
type DoneOrderProps = Omit<Order, 'id' | 'userId'>;
export const DoneOrder = ({ date, address, totalCount, totalPrice, items }: DoneOrderProps) => {
                        ...
                        {onenMore && (
                            <motion.div
                                ...
                                {items.map((item) => (
                                    <div
                                        key={item.id}
                                        className=" grid grid-cols-[1fr_1fr_auto_auto] sm:grid-cols-[auto_1fr_auto_auto] my-4">
                                        <img
