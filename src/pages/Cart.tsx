...
import { showModal, toOrderOn } from '../redux/slices/modal/modalSlice';
...
const CartHead = ({ onClear }: CartHeadProps) => (
...
interface CartFootProps {
    totalPrice: number;
    totalCount: number;
    handlePlaceOrder: () => void;
}

const CartFoot = ({ totalPrice, totalCount, handlePlaceOrder }: CartFootProps) => (
    <div className=" mt-10">
